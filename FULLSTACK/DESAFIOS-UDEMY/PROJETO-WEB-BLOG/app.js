...
app.get("/posts/:Test", function (req, res) {
  const Paramm = _.lowerCase(req.params.Test)
  
  posts.forEach(function(post){
    const storedTitile = _.lowerCase(post.Titulo);
    const storedText = post.Texto;

    if (storedTitile === Paramm) {
      res.render(__dirname + "/views/post.ejs", { 
        startingContent:  _.startCase(storedTitile),
        posts: storedText,
      })
    }
